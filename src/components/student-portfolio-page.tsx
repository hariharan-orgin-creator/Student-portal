...
export function StudentPortfolioPage() {
  ...
  return (
    <div className="mx-auto max-w-lg space-y-4">
      <DuoCard className="bg-linear-to-br from-[oklch(0.96_0.08_145)] to-card p-4">
        <div className="flex items-center gap-3">
          <div className="relative">
            <div className="grid size-16 place-items-center rounded-full border-[3px] border-duo-green bg-card text-3xl">
              {settings.identity.avatar}
            </div>
            <span className="absolute -bottom-0.5 -right-0.5 grid size-6 place-items-center rounded-full bg-duo-purple text-[9px] font-bold text-white">
              L4
            </span>
          </div>
          <div className="min-w-0 flex-1">
            <h1 className="font-display text-lg font-bold">Aisyah</h1>
            <p className="text-xs font-bold text-duo-green-dark">
        ...
        <div className="mt-3 grid grid-cols-3 gap-2">
          <div className="rounded-xl bg-card/80 px-2 py-2 text-center">
            <Star className="mx-auto size-4 fill-duo-yellow text-duo-yellow" />
